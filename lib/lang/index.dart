...
import 'dart:async';
import 'dart:convert';
import 'package:flutter_a9vg/lang/config.dart' as I18NConfig;
...
class AppLocalizations {
  ...
  static Future getLanguageJson([Locale locale]) async {
    ...
    try {
      jsonLang =
          await rootBundle.loadString('lib/lang/locale/${_tmpLocale.languageCode}.json');
    } catch (e) {
      print('-------------------------------------------------');
      print(I18NConfig.ConfigLanguage.defualtLanguage['code']);
      _inst._locale = Locale(I18NConfig.ConfigLanguage.defualtLanguage['code']);
      jsonLang = await rootBundle.loadString(
          'lib/lang/locale/${I18NConfig.ConfigLanguage.defualtLanguage['code']}.json');
    }
